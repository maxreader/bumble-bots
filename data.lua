...
bumble_bots.bot_size_multiplier =
    botSizeDict[settings.startup["bumble-bots-bee-size"].value]
...
local set_construction_sprites_with_mask =
...
if mods["pyindustry"] then
    ...
    set_construction_sprites_with_mask("py-construction-robot-01",
                                       {197, 69, 9, 155})
    set_hive_sprites_with_mask("py-roboport-mk01", {255, 169, 10, 240},
                               animated, 0.75)
end
