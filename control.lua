...
script.on_event({
    ...
    if (entity.name) == "roboport" then add_hive(event.entity) end
end)

script.on_init(function() regenerate_beehives() end)

script.on_configuration_changed(function() regenerate_beehives() end)
