...
set_construction_sprites_with_mask("construction-robot", {
    255, 200, 80, 155
})
...
if mods["boblogistics"] then
    ...
    for robot, color in pairs(logisticMapping) do set_logistic_sprites_with_mask(robot, color) end
    ...
    for robot, color in pairs(hiveMapping) do set_hive_sprites_with_mask(robot, color) end
    require("prototypes.bobs-bot-parts")
end

if mods["pyindustry"] then
    set_logistic_sprites_with_mask("py-logistic-robot-01", {
        171, 19, 19, 179
    })
    set_construction_sprites_with_mask("py-construction-robot-01", {
        197, 69, 9, 155
    })
    set_hive_sprites_with_mask("py-roboport-mk01", {
        255, 169, 10, 240
    }, animated, 0.75)
end

if mods["pyhightech"] then
    set_logistic_sprites_with_mask("logistic-robot-ht", {
        46, 203, 255, 179
    }, 1.25)
    set_construction_sprites_with_mask("construction-robot-ht", {
        3, 17, 67, 179
    }, 1.25)
end

if mods["FactorioExtended-Plus-Logistics"] then
    set_logistic_sprites_with_mask("logistic-robot-mk2", {
        3, 252, 173, 179
    })
    set_logistic_sprites_with_mask("logistic-robot-mk3", {
        0, 52, 255, 179
    })
    set_construction_sprites_with_mask("construction-robot-mk2", {
        3, 252, 173, 179
    })
    set_construction_sprites_with_mask("construction-robot-mk3", {
        0, 52, 255, 179
    })
    set_hive_sprites_with_mask("roboport-mk2", {
        3, 252, 173, 240
    })
    set_hive_sprites_with_mask("roboport-mk3", {
        0, 52, 255, 240
    })
end

if mods["skan-fusion-robots"] then
    set_logistic_sprites_with_mask("skan-logistic-robot-fusion", {
        0, 81, 255, 179
    })
...
if mods["angelsindustries"] then
    set_logistic_sprites_with_mask("cargo-robot", {
        161, 129, 0, 179
    }, 0.75)
    set_logistic_sprites_with_mask("cargo-robot-2", {
        0, 0, 0, 179
    }, 0.85)
    set_construction_sprites_with_mask("angels-construction-robot", {
        161, 129, 0, 179
    }, 0.75)
end

data.raw["utility-constants"].default.main_menu_background_image_location =
    "__bumble-bots__/graphics/title_screen.png"
